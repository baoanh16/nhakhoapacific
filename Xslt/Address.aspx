										...
										<ItemTemplate>
											<div class="address-col">
												<div class="address default clearfix">
													...
													<asp:LinkButton ID="hplDeleteAddress" Visible="false" CommandName="DeleteAddress" CommandArgument='<%#Eval("AddressId")%>'
													 CssClass="btn-deleteaddr" Text="Xóa" runat="server" />
												</div>
											</div>
										</ItemTemplate>
									</asp:Repeater>
